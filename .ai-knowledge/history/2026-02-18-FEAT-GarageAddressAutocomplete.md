...
3. **Integrated Map Search**: Added a dedicated search box within the `GarageMapPicker` component.
4. **Legal & Compliance**: Implemented a modern, professional **Privacy Policy** page at `/privacy`. This page is specifically designed to meet **Meta Platform Policies** for App Review, covering:
    - Data collection (Name, Email, Location).
    - Messenger Platform Data usage (PSID processing).
    - User rights and data deletion protocols.
    - Third-party processor transparency (PayMongo, Cloudinary).
