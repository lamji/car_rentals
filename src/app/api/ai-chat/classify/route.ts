...
- "follow_up" — user is asking about a car they were ALREADY shown. Questions about price, availability on a date, self-drive, features, booking, etc. Examples: "is that car available today?", "how much is 12 hours?", "is it self-drive?", "what about march 10?", "hmm how much is the driver fee?"
- "booking_lookup" — user wants to check/track their existing booking. Examples: "check my booking", "where is my booking?", "booking status"
- "book_car" — user wants to book/reserve a previously shown car. Examples: "yes I want to book", "book that car", "let's go", "yes", "sure proceed"
