  ...
  return (
    <div className={className}>
      <div className="relative h-[100vh] sm:h-[60vh] md:h-[60vh] lg:h-[60vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10 bg-[#efeef6]">
          <Image
        ...
        <div className="flex h-full items-center justify-end px-0">
          ...
          <div className="w-[400px] flex h-full items-center justify-end px-0">
            <div className="w-full max-w-5xl space-y-8">
              {/* Top: marketing text */}
              <div className="text-center text-black sm:px-4">
                <h1 className="text-2xl text-black font-black uppercase leading-tight sm:text-4xl md:text-5xl">
                  Rent a <span className="text-yellow-400">Car Today!</span>
                </h1>
                <p className="mt-1 text-sm font-semibold text-black sm:text-lg md:text-xl">
