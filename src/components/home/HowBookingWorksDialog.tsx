...
export function HowBookingWorksDialog() {
  ...
  return (
    <>
      ...
      {/* Chat Panel */}
      {open && (
        <div ref={chatPanelRef} className="fixed inset-0 z-9999 bg-white flex flex-col sm:inset-auto sm:bottom-32 sm:right-2 sm:w-[380px] sm:max-h-[70vh] sm:rounded-2xl sm:shadow-2xl sm:border sm:border-gray-200 sm:animate-in sm:slide-in-from-bottom-4 sm:duration-200">
          {/* Header */}
          <div className="flex items-center gap-3 px-4 py-3 bg-linear-to-r from-blue-600 to-blue-700 text-white shrink-0">
          ...
          {/* Messages — flex-col-reverse keeps scroll anchored to bottom like messenger */}
