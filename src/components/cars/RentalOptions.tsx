  ...
  return (
    <div data-testid="rental-options-section" className="border-t border-gray-200 pt-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div className="absolute top-0 right-0 h-16 w-16 bg-linear-to-br from-blue-500 to-blue-600 rounded-bl-2xl"></div>
        ...
        >
          <div className="absolute top-0 right-0 h-16 w-16 bg-linear-to-br from-green-500 to-green-600 rounded-bl-2xl"></div>
          <div className="relative">
            <div className="mb-4">
        ...
        >
          <div className="absolute top-0 right-0 h-16 w-16 bg-linear-to-br from-purple-500 to-purple-600 rounded-bl-2xl"></div>
          <div className="relative">
            <div className="mb-4">
