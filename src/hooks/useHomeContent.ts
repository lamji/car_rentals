...
export function useHomeContent() {
  ...
  const handleLocationSelect = useCallback(async (locationString: string) => {
  ...
  const handleSelectGarage = useCallback((carId: string) => {
  ...
  const detailsHrefFor = useCallback((id: string) => {
